...
import img1 from "./Business.png"; // Background image for Business Analysis
      ...
      <div style={styles.container}>
        <div style={styles.overlay}>
          <div style={styles.content}>
            <h1 style={styles.title}>BUSINESS ANALYSIS</h1>
            <br />
            <h2 style={styles.subtitle}>UNLOCK POTENTIAL</h2>
            <h2 style={styles.subtitle}>AND DRIVE GROWTH</h2>
            <button
