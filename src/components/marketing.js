    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <main className="pt-20 pb-16 px-4">
        <div className="max-w-4xl mx-auto"> {/* Center content with max-width */}
          <center>
          <h1 className="lekton-font text-4xl md:text-5xl font-bold text-black mb-12">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="lekton-font text-3xl font-bold mb-4">ACHIEVE MORE THAN JUST CONTENT</h2>
        <p className=" Arial-font font-semibold mb-12 text-pink-600">
          YOU CAN LEARN ABOUT A FULL RANGE OF CONTENT MARKETING SERVICES <br/>DESIGNED TO IMPROVE YOUR BRAND'S ONLINE VISIBILITY AND <br/>SUCCESSFULLY INTERACT WITH 
                    YOUR TARGET MARKET.
        </p>
